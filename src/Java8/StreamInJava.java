...
public class StreamInJava {
    public static void main(String[] args) {    
         ...
         * the filter() method returns another stream of names with length less than 5, 
        ...
        /**
         * the stream() method returns a stream of all the numbers, 
         * the filter() method returns another stream of numbers which are exactly divided by 3, 
         * the forEach() method returns the list of that stream. 
         */
